    ...
    return (
        <Flex textAlign={'center'} flexDirection={'column'} pr={'5'} pl={'5'} >
            <Flex alignItems={'center'} justifyContent={'space-between'} mt={'12'}>
                <Heading color={'blue.400'} display={['block', 'block', 'block', 'block', 'block']}>
                    Expense Tracker
                </Heading>
            ...
            <Flex w={'full'} alignItems={'flex-start'} justifyContent={'space-evenly'} flexDirection={['row', 'column', 'column', 'row', 'row']}>
